        ...
        <div className='md:flex md:min-h-screen '>
            ...
            <div className='md:w-1/5 bg-gray-800 px-5 py-4'>
                ...
                <ul className="mt-5">
                    ...
                    <li className="text-center">
                        <Link to='/dashboard/productos' className={`${urlActual === '/dashboard/productos' ? 'text-slate-100 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-600'} text-xl block mt-2 hover:text-slate-600`}>Vehiculos</Link>
                    </li>

                    <li className="text-center">
                        <Link to='/dashboard/clientes' className={`${urlActual === '/dashboard/clientes' ? 'text-slate-100 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-600'} text-xl block mt-2 hover:text-slate-600`}>Clientes</Link>
                    </li>

                    <li className="text-center">
                        <Link to='/dashboard/pedidos' className={`${urlActual === '/dashboard/pedidos' ? 'text-slate-100 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-600'} text-xl block mt-2 hover:text-slate-600`}>Reservas</Link>
                    </li>
